...
class StoreInRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'text' => 'nullable|string|required_without:attachment',
            'attachment' => 'nullable|file|max:15360|required_without:text|mimetypes:image/jpeg,image/png,image/gif,image/webp',
            'bot_tg_id' => 'required|numeric',
            'bot_db_id' => 'required|numeric',
            'bot_username' => 'nullable|string',
            'ticket_type' => 'required|string',
            'ticket_id' => 'required|string',
            'ticket_domain' => 'required|string',
        ];
    }
}
