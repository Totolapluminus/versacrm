...
Route::get('/link/create', [LinkController::class, 'create'])->name('link.create')->middleware(['auth']);
Route::post('/link', [LinkController::class, 'store'])->name('link.store')->middleware(['auth']);
